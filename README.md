...
| Plugin | AiiDA | Python |
|-       |-      |-       |
| `v0.7.0 < v1.0.0` | ![Compatibility for v0.7][AiiDA v2.x] |  [![PyPI pyversions](https://img.shields.io/pypi/pyversions/aiida-pseudo/0.7.0.svg)](https://pypi.python.org/pypi/aiida-pseudo/) |
